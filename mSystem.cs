...
public class mSystem
{
  ...
  public static int getWidth(Image img) => mSystem.clientType == 5 ? img.getWidth() : img.getWidth();

  public static int getHeight(Image img) => mSystem.clientType == 5 ? img.getHeight() : img.getWidth();

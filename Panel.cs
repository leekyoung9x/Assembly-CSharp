...
public class Panel : IActionListener, IChatable
{
  ...
  private void paintPetStatus(mGraphics g)
  {
    ...
    for (int index = 0; index < this.strStatus.Length; ++index)
    {
      ...
      if (y - this.cmy <= this.yScroll + this.hScroll && y - this.cmy >= this.yScroll - this.ITEM_HEIGHT)
      {
        ...
        mFont.tahoma_7b_dark.drawString(g, this.strStatus[index], this.xScroll + 10, y + 6, mFont.LEFT);
      }
    }
    this.paintScrollArrow(g);
  }
  ...
  private void paintSkill(mGraphics g)
  {
    ...
    {
      int x1 = this.xScroll + 30;
      int y1 = this.yScroll + index1 * this.ITEM_HEIGHT;
      int w1 = this.wScroll - 30;
      int h = this.ITEM_HEIGHT - 1;
      int xScroll = this.xScroll;
      int y2 = this.yScroll + index1 * this.ITEM_HEIGHT;
      ...
      if (y1 - this.cmy <= this.yScroll + this.hScroll && y1 - this.cmy >= this.yScroll - this.ITEM_HEIGHT)
      {
        ...
        if (index1 == 0)
        {
          ...
          mFont.tahoma_7b_blue.drawString(g, st, x1 + 5, y1 + 3, 0);
          mFont.tahoma_7_green2.drawString(g, NinjaUtil.getMoneys((long) (Char.myCharz().cHPGoc + 1000)) + " " + mResources.potential + ": " + mResources.increase + " " + (object) Char.myCharz().hpFrom1000TiemNang, x1 + 5, y1 + 15, 0);
        }
        if (index1 == 1)
        {
          ...
          mFont.tahoma_7b_blue.drawString(g, st, x1 + 5, y1 + 3, 0);
          mFont.tahoma_7_green2.drawString(g, NinjaUtil.getMoneys((long) (Char.myCharz().cMPGoc + 1000)) + " " + mResources.potential + ": " + mResources.increase + " " + (object) Char.myCharz().mpFrom1000TiemNang, x1 + 5, y1 + 15, 0);
        }
        if (index1 == 2)
        {
          ...
          mFont.tahoma_7b_blue.drawString(g, st, x1 + 5, y1 + 3, 0);
          mFont.tahoma_7_green2.drawString(g, NinjaUtil.getMoneys((long) (Char.myCharz().cDamGoc * 100)) + " " + mResources.potential + ": " + mResources.increase + " " + (object) Char.myCharz().damFrom1000TiemNang, x1 + 5, y1 + 15, 0);
        }
        if (index1 == 3)
        {
          ...
          mFont.tahoma_7b_blue.drawString(g, st, x1 + 5, y1 + 3, 0);
          mFont.tahoma_7_green2.drawString(g, NinjaUtil.getMoneys((long) (500000 + Char.myCharz().cDefGoc * 100000)) + " " + mResources.potential + ": " + mResources.increase + " " + (object) Char.myCharz().defFrom1000TiemNang, x1 + 5, y1 + 15, 0);
        }
        if (index1 == 4)
        {
          ...
          int index2 = Char.myCharz().cCriticalGoc;
          if (index2 > Panel.t_tiemnang.Length - 1)
            index2 = Panel.t_tiemnang.Length - 1;
          long num2 = Panel.t_tiemnang[index2];
          mFont.tahoma_7b_blue.drawString(g, st, x1 + 5, y1 + 3, 0);
          long number = num2;
          mFont.tahoma_7_green2.drawString(g, Res.formatNumber2(number) + " " + mResources.potential + ": " + mResources.increase + " " + (object) Char.myCharz().criticalFrom1000Tiemnang, x1 + 5, y1 + 15, 0);
        }
        if (index1 == 5)
        {
          if (Panel.specialInfo != null)
          {
            ...
            for (int index3 = 0; index3 < strArray.Length; ++index3)
              mFont.tahoma_7_green2.drawString(g, strArray[index3], x1 + 5, y1 + 3 + index3 * 12, 0);
          }
          else
            mFont.tahoma_7_green2.drawString(g, string.Empty, x1 + 5, y1 + 9, 0);
        }
        if (index1 >= 6)
        {
          int index4 = index1 - 6;
          ...
          if (skill1 != null)
          {
            mFont.tahoma_7b_blue.drawString(g, skillTemplate.name, x1 + 5, y1 + 3, 0);
            mFont.tahoma_7_blue.drawString(g, mResources.level + ": " + (object) skill1.point, x1 + w1 - 5, y1 + 3, mFont.RIGHT);
            if (skill1.point == skillTemplate.maxPoint)
              mFont.tahoma_7_green2.drawString(g, mResources.max_level_reach, x1 + 5, y1 + 15, 0);
            else if (skill1.template.isSkillSpec())
            {
              string str = mResources.proficiency + ": ";
              int x2 = mFont.tahoma_7_green2.getWidthExactOf(str) + x1 + 5;
              int y3 = y1 + 15;
              mFont.tahoma_7_green2.drawString(g, str, x1 + 5, y3, 0);
              mFont.tahoma_7_green2.drawString(g, "(" + skill1.strCurExp() + ")", x1 + w1 - 5, y3, mFont.RIGHT);
              int y4 = y3 + 4;
              g.setColor(7169134);
              g.fillRect(x2, y4, 50, 5);
              int w2 = (int) skill1.curExp * 50 / 1000;
              g.setColor(11992374);
              g.fillRect(x2, y4, w2, 5);
              if (skill1.curExp < (short) 1000)
                ;
            }
            else
            {
              Skill skill2 = skillTemplate.skills[skill1.point];
              mFont.tahoma_7_green2.drawString(g, mResources.level + " " + (object) (skill1.point + 1) + " " + mResources.need + " " + Res.formatNumber2(skill2.powRequire) + " " + mResources.potential, x1 + 5, y1 + 15, 0);
            }
          }
          else
          {
            Skill skill3 = skillTemplate.skills[0];
            mFont.tahoma_7b_green.drawString(g, skillTemplate.name, x1 + 5, y1 + 3, 0);
            mFont.tahoma_7_green2.drawString(g, mResources.need_upper + " " + Res.formatNumber2(skill3.powRequire) + " " + mResources.potential_to_learn, x1 + 5, y1 + 15, 0);
          }
        }
      }
    }
          ...
          default:
            if (this.isSearchClan)
            {
              if (this.clans != null && this.clans.Length != 0)
              {
                ...
                {
                  if (ClanImage.getClanImage((short) this.clans[index1 - 2].imgID).idImage != null)
                    SmallImage.drawSmallImage(g, (int) ClanImage.getClanImage((short) this.clans[index1 - 2].imgID).idImage[0], xScroll + w1 / 2, y1 + h1 / 2, 0, StaticObj.VCENTER_HCENTER);
                }
                else
                {
                ...
                string st = this.clans[index1 - 2].name.Length <= 23 ? this.clans[index1 - 2].name : this.clans[index1 - 2].name.Substring(0, 23) + "...";
                mFont.tahoma_7b_green2.drawString(g, st, x + 5, y2, 0);
  ...
  private void paintInventory(mGraphics g)
  {
    ...
    for (int index = 0; index < num1; ++index)
    {
      int num2 = index != this.newSelected || this.selected != 0 ? 0 : (GameCanvas.gameTick % 10 >= 7 ? 0 : -1);
      g.setColor(index != this.newSelected ? 15723751 : 16383818);
      g.fillRect(this.xScroll + index * this.TAB_W_NEW, 89 + num2 - 10, this.TAB_W_NEW - 1, 21);
      if (index == this.newSelected)
      {
        g.setColor(13524492);
        int x = this.xScroll + index * this.TAB_W_NEW;
        int num3 = 89 + num2 - 10 + 21;
        g.fillRect(x, num3 - 3, this.TAB_W_NEW - 1, 3);
      }
      mFont.tahoma_7_grey.drawString(g, string.Empty + (object) (index + 1), this.xScroll + index * this.TAB_W_NEW + this.TAB_W_NEW / 2, 91 + num2 - 10, mFont.CENTER);
    }
    g.setClip(this.xScroll, this.yScroll + 21, this.wScroll, this.hScroll - 21);
    g.translate(0, -this.cmy);
    try
    {
      for (int select = 1; select < this.currentListLength; ++select)
      {
        int x = this.xScroll + 36;
        int y1 = this.yScroll + select * this.ITEM_HEIGHT;
        int w1 = this.wScroll - 36;
        ...
        if (y1 - this.cmy <= this.yScroll + this.hScroll && y1 - this.cmy >= this.yScroll - this.ITEM_HEIGHT)
        {
          ...
          if (obj != null)
          {
            for (int index = 0; index < obj.itemOption.Length; ++index)
            {
              if (obj.itemOption[index].optionTemplate.id == 72 && obj.itemOption[index].param > 0)
              {
                byte colorItemUpgrade = (byte) Panel.GetColor_Item_Upgrade(obj.itemOption[index].param);
                if (Panel.GetColor_ItemBg((int) colorItemUpgrade) != -1)
                  g.setColor(select != this.selected ? Panel.GetColor_ItemBg((int) colorItemUpgrade) : Panel.GetColor_ItemBg((int) colorItemUpgrade));
              }
            }
  ...
  private void doFireSkill()
  {
    ...
    else if (this.selected == 0 || this.selected == 1 || this.selected == 2 || this.selected == 3 || this.selected == 4 || this.selected == 5)
    {
      ...
      if (this.selected == 0)
      {
        ...
        {
          GameCanvas.startOKDlg(mResources.not_enough_potential_point1 + (object) Char.myCharz().cTiemNang + mResources.not_enough_potential_point2 + (object) (Char.myCharz().cHPGoc + num));
          return;
        }
        ...
        if (cTiemNang >= (long) (100 * (2 * (cHpGoc + num) + 1980) / 2))
        {
          ...
          menuItems.addElement((object) new Command(mResources.increase_upper + "\n" + (object) Char.myCharz().hpFrom1000TiemNang + mResources.HP + "\n-" + Res.formatNumber2((long) (cHpGoc + num)), (IActionListener) this, 9000, (object) null));
          menuItems.addElement((object) new Command(mResources.increase_upper + "\n" + (object) (10 * (int) Char.myCharz().hpFrom1000TiemNang) + mResources.HP + "\n-" + Res.formatNumber2((long) (10 * (2 * (cHpGoc + num) + 180) / 2)), (IActionListener) this, 9006, (object) null));
          menuItems.addElement((object) new Command(mResources.increase_upper + "\n" + (object) (100 * (int) Char.myCharz().hpFrom1000TiemNang) + mResources.HP + "\n-" + Res.formatNumber2((long) (100 * (2 * (cHpGoc + num) + 1980) / 2)), (IActionListener) this, 9007, (object) null));
          GameCanvas.menu.startAt(menuItems, this.X, (this.selected + 1) * this.ITEM_HEIGHT - this.cmy + this.yScroll);
          this.addSkillDetail2(this.selected);
        }
      }
      if (this.selected == 1)
      {
        ...
        {
          GameCanvas.startOKDlg(mResources.not_enough_potential_point1 + (object) Char.myCharz().cTiemNang + mResources.not_enough_potential_point2 + (object) (Char.myCharz().cMPGoc + num));
          return;
        }
        ...
        {
          MyVector menuItems = new MyVector(string.Empty);
          menuItems.addElement((object) new Command(mResources.increase_upper + "\n" + (object) Char.myCharz().mpFrom1000TiemNang + mResources.KI + "\n-" + Res.formatNumber2((long) (cMpGoc + num)), (IActionListener) this, 9000, (object) null));
          menuItems.addElement((object) new Command(mResources.increase_upper + "\n" + (object) (10 * (int) Char.myCharz().mpFrom1000TiemNang) + mResources.KI + "\n-" + Res.formatNumber2((long) (10 * (2 * (cMpGoc + num) + 180) / 2)), (IActionListener) this, 9006, (object) null));
          menuItems.addElement((object) new Command(mResources.increase_upper + "\n" + (object) (100 * (int) Char.myCharz().mpFrom1000TiemNang) + mResources.KI + "\n-" + Res.formatNumber2((long) (100 * (2 * (cMpGoc + num) + 1980) / 2)), (IActionListener) this, 9007, (object) null));
          GameCanvas.menu.startAt(menuItems, this.X, (this.selected + 1) * this.ITEM_HEIGHT - this.cmy + this.yScroll);
          this.addSkillDetail2(this.selected);
        }
      }
      if (this.selected == 2)
      {
        ...
        {
          GameCanvas.startOKDlg(mResources.not_enough_potential_point1 + (object) Char.myCharz().cTiemNang + mResources.not_enough_potential_point2 + (object) (cDamGoc * 100));
          return;
        }
        ...
        {
          MyVector menuItems = new MyVector(string.Empty);
          menuItems.addElement((object) new Command(mResources.increase_upper + "\n" + (object) Char.myCharz().damFrom1000TiemNang + "\n" + mResources.hit_point + "\n-" + Res.formatNumber2((long) (cDamGoc * 100)), (IActionListener) this, 9000, (object) null));
          menuItems.addElement((object) new Command(mResources.increase_upper + "\n" + (object) (10 * (int) Char.myCharz().damFrom1000TiemNang) + "\n" + mResources.hit_point + "\n-" + Res.formatNumber2((long) (10 * (2 * cDamGoc + 9) / 2 * (int) Char.myCharz().expForOneAdd)), (IActionListener) this, 9006, (object) null));
          GameCanvas.menu.startAt(menuItems, this.X, (this.selected + 1) * this.ITEM_HEIGHT - this.cmy + this.yScroll);
          this.addSkillDetail2(this.selected);
        }
        if (cTiemNang >= (long) (100 * (2 * cDamGoc + 99) / 2 * (int) Char.myCharz().expForOneAdd))
        {
          ...
          menuItems.addElement((object) new Command(mResources.increase_upper + "\n" + (object) Char.myCharz().damFrom1000TiemNang + "\n" + mResources.hit_point + "\n-" + Res.formatNumber2((long) (cDamGoc * 100)), (IActionListener) this, 9000, (object) null));
          menuItems.addElement((object) new Command(mResources.increase_upper + "\n" + (object) (10 * (int) Char.myCharz().damFrom1000TiemNang) + "\n" + mResources.hit_point + "\n-" + Res.formatNumber2((long) (10 * (2 * cDamGoc + 9) / 2 * (int) Char.myCharz().expForOneAdd)), (IActionListener) this, 9006, (object) null));
          menuItems.addElement((object) new Command(mResources.increase_upper + "\n" + (object) (100 * (int) Char.myCharz().damFrom1000TiemNang) + "\n" + mResources.hit_point + "\n-" + Res.formatNumber2((long) (100 * (2 * cDamGoc + 99) / 2 * (int) Char.myCharz().expForOneAdd)), (IActionListener) this, 9007, (object) null));
          GameCanvas.menu.startAt(menuItems, this.X, (this.selected + 1) * this.ITEM_HEIGHT - this.cmy + this.yScroll);
          this.addSkillDetail2(this.selected);
        }
      }
      if (this.selected == 3)
      {
        ...
        {
          long number1 = (long) (2 * (cDefGoc + 5)) / 2L * 100000L;
          ...
          MyVector menuItems = new MyVector(string.Empty);
          menuItems.addElement((object) new Command(mResources.use_potential_point_for1 + "\n1 " + mResources.armor + "\n" + Res.formatNumber2(number1), (IActionListener) this, 9000, (object) null));
          menuItems.addElement((object) new Command(mResources.use_potential_point_for1 + "\n10 " + mResources.armor + "\n" + Res.formatNumber2(number2), (IActionListener) this, 9006, (object) null));
          menuItems.addElement((object) new Command(mResources.use_potential_point_for1 + "\n100 " + mResources.armor + "\n" + Res.formatNumber2(number3), (IActionListener) this, 9007, (object) null));
          GameCanvas.menu.startAt(menuItems, this.X, (this.selected + 1) * this.ITEM_HEIGHT - this.cmy + this.yScroll);
          this.addSkillDetail2(this.selected);
        }
      }
      ...
      {
        int index = Char.myCharz().cCriticalGoc;
        if (index > Panel.t_tiemnang.Length - 1)
          index = Panel.t_tiemnang.Length - 1;
        long number = Panel.t_tiemnang[index];
        if (Char.myCharz().cTiemNang < number)
          GameCanvas.startOKDlg(mResources.not_enough_potential_point1 + Res.formatNumber2(Char.myCharz().cTiemNang) + mResources.not_enough_potential_point2 + Res.formatNumber2(number));
        else
          GameCanvas.startYesNoDlg(mResources.use_potential_point_for1 + Res.formatNumber(number) + mResources.use_potential_point_for2 + (object) Char.myCharz().criticalFrom1000Tiemnang + mResources.for_crit, new Command(mResources.increase_upper, (IActionListener) this, 9000, (object) null), new Command(mResources.CANCEL, (IActionListener) this, 4007, (object) null));
      }
      else
      {
        if (this.selected != 5)
  ...
  private void paintOption(mGraphics g)
  {
    ...
    for (int index = 0; index < Panel.strCauhinh.Length; ++index)
    {
      ...
      if (y - this.cmy <= this.yScroll + this.hScroll && y - this.cmy >= this.yScroll - this.ITEM_HEIGHT)
      {
        g.setColor(index != this.selected ? 15196114 : 16383818);
        g.fillRect(xScroll, y, w, h);
        mFont.tahoma_7b_dark.drawString(g, Panel.strCauhinh[index], this.xScroll + 10, y + 6, mFont.LEFT);
      }
    }
    this.paintScrollArrow(g);
  }
  ...
  private bool isTabInven() => this.type == 0 && this.currentTabIndex == 1 || this.type == 7 && this.currentTabIndex == 0;

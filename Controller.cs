...
public class Controller : IMessageHandler
{
  ...
  public void onMessage(Message msg)
  {
    ...
    try
    {
      Res.outz("<<<Read cmd= " + (object) msg.command);
      ...
      switch ((int) command1 + 99)
      {
        case 0:
          ...
          if (msg.reader().readByte() == (sbyte) 0)
          {
            ...
            for (int index = 0; index < num; ++index)
            {
              ...
              char3.head = (int) msg.reader().readShort();
              char3.headICON = (int) msg.reader().readShort();
              char3.body = (int) msg.reader().readShort();
              char3.leg = (int) msg.reader().readShort();
              char3.bag = (int) msg.reader().readShort();
        ...
        case 4:
          ...
          if (num9 == (sbyte) 0)
          {
            ...
            {
              char1 = GameScr.findCharInMap(num10);
              if (char1 != null)
              {
                char1.mobMe = new Mob(num10, false, false, false, false, false, (int) templateId, 1, num11, (sbyte) 0, num11, (short) char1.cx, (short) char1.cy, (sbyte) 4, (sbyte) 0)
                {
                  isMobMe = true
                };
                GameScr.vMob.addElement((object) char1.mobMe);
              }
          ...
          if (num9 == (sbyte) 1)
          {
            ...
            {
              char1 = GameScr.findCharInMap(charId);
              if (char1 != null && GameScr.findMobInMap(mobId) != null)
                char1.mobMe.attackOtherMob(GameScr.findMobInMap(mobId));
            }
          }
          if (num9 == (sbyte) 2)
          {
            ...
            if (mobId == Char.myCharz().charID)
            {
              ...
              if (char1 != null)
              {
                ...
                {
                  char1.doInjure(HPShow, 0, false, true);
                }
                else
                {
                  Char.myCharz().mobMe.dame = HPShow;
                  Char.myCharz().mobMe.setAttack(char1);
                }
              }
            }
            else
          ...
          if (num9 == (sbyte) 3)
          {
            ...
            char2 = (Char) null;
            char1 = Char.myCharz().charID != charId ? GameScr.findCharInMap(charId) : Char.myCharz();
            if (char1 != null)
            {
              Mob mobInMap = GameScr.findMobInMap(mobId);
              if (char1.mobMe != null)
                char1.mobMe.attackOtherMob(mobInMap);
              if (mobInMap != null)
              {
                mobInMap.hp = num13;
                mobInMap.updateHp_bar();
                if (num14 == 0)
                {
          ...
          if (num9 == (sbyte) 5)
          {
            ...
            char2 = (Char) null;
            char1 = charId != Char.myCharz().charID ? GameScr.findCharInMap(charId) : Char.myCharz();
            if (char1 == null)
              break;
            if ((TileMap.tileTypeAtPixel(char1.cx, char1.cy) & 2) == 2)
              char1.setSkillPaint(GameScr.sks[(int) index], 0);
            else
              char1.setSkillPaint(GameScr.sks[(int) index], 1);
            Mob mobInMap = GameScr.findMobInMap(mobId);
            char1.cdir = char1.cx > mobInMap.x ? -1 : 1;
            char1.mobFocus = mobInMap;
            mobInMap.hp = num16;
            mobInMap.updateHp_bar();
        ...
        case 9:
          ...
          Res.outz("===> UPDATE_BODY:    type = " + (object) num19);
          char1 = Char.myCharz().charID != charId1 ? GameScr.findCharInMap(charId1) : Char.myCharz();
          if (num19 != (sbyte) -1)
          {
            ...
            Res.err("====> Cmd: -90 UPDATE_BODY   \n  isMonkey= " + (object) num23 + " head=  " + (object) num20 + " body= " + (object) num21 + " legU= " + (object) num22);
            if (char1 != null)
            {
              if (char1.charID == charId1)
              {
                char1.isMask = true;
                char1.isMonkey = num23;
                if (char1.isMonkey != (sbyte) 0)
                {
                  char1.isWaitMonkey = false;
                  char1.isLockMove = false;
                }
              }
              else if (char1 != null)
              {
              ...
              if (num20 != (short) -1)
                char1.head = (int) num20;
              if (num21 != (short) -1)
                char1.body = (int) num21;
              if (num22 != (short) -1)
                char1.leg = (int) num22;
            }
          }
          if (num19 == (sbyte) -1 && char1 != null)
          {
            char1.isMask = false;
            char1.isMonkey = (sbyte) 0;
          }
          if (char1 == null)
            goto case 41;
          else
        ...
        case 33:
          ...
          if (id1 == (short) 78)
          {
            ...
            short[][] numArray2 = new short[(int) length10][];
            for (int index17 = 0; index17 < (int) length10; ++index17)
            {
              int length11 = (int) msg.reader().readUnsignedByte();
              numArray2[index17] = new short[length11];
              for (int index18 = 0; index18 < length11; ++index18)
                numArray2[index17][index18] = msg.reader().readShort();
            }
            effDataById.anim_data = numArray2;
            goto case 41;
          }
          else
            goto case 41;
        ...
        case 35:
          ...
          char2 = (Char) null;
          char1 = charId3 != Char.myCharz().charID ? GameScr.findCharInMap(charId3) : Char.myCharz();
          char1.bag = num58;
          if (char1.bag >= 201 && char1.bag < (int) byte.MaxValue)
          {
            char1.addEffChar(new Effect(char1.bag, char1, 2, -1, 10, (sbyte) 1)
            {
              typeEff = 5
            });
          }
          ...
          {
            for (int index19 = 0; index19 < 54; ++index19)
              char1.removeEffChar(0, 201 + index19);
          }
          Res.outz("cmd:-64 UPDATE BAG PLAER = " + (char1 != null ? (object) char1.cName : (object) string.Empty) + (object) charId3 + " BAG ID= " + (object) num58);
          goto case 41;
        case 36:
          Res.outz("GET BAG");
          ...
          if (length12 > (sbyte) 0)
          {
            v.idImage = new short[(int) length12];
            for (int index20 = 0; index20 < (int) length12; ++index20)
            {
              v.idImage[index20] = msg.reader().readShort();
              Res.outz("ID=  " + (object) num59 + " frame= " + (object) v.idImage[index20]);
            }
        ...
        case 37:
          ...
          sbyte length13 = msg.reader().readByte();
          if (length13 > (sbyte) 0)
          {
            ClanImage clanImage = ClanImage.getClanImage((short) ID);
            if (clanImage != null)
            {
              clanImage.idImage = new short[(int) length13];
              for (int index21 = 0; index21 < (int) length13; ++index21)
              {
                clanImage.idImage[index21] = msg.reader().readShort();
                if (clanImage.idImage[index21] > (short) 0)
                  SmallImage.vKeys.addElement((object) (clanImage.idImage[index21].ToString() + string.Empty));
              }
              goto case 41;
            }
            else
        ...
        case 39:
          ...
          if (charId5 != Char.myCharz().charID)
          {
            ...
            int index22 = (int) msg.reader().readUnsignedByte();
            Res.outz("player skill ID= " + (object) index22);
            if ((TileMap.tileTypeAtPixel(charInMap.cx, charInMap.cy) & 2) == 2)
              charInMap.setSkillPaint(GameScr.sks[index22], 0);
            else
              charInMap.setSkillPaint(GameScr.sks[index22], 1);
            sbyte length14 = msg.reader().readByte();
            Res.outz("nAttack = " + (object) length14);
            Char[] charArray = new Char[(int) length14];
            int length15;
            for (length15 = 0; length15 < charArray.Length; ++length15)
            {
              ...
              if (charId6 == Char.myCharz().charID)
              {
                ...
                char5 = GameScr.findCharInMap(charId6);
              charArray[length15] = char5;
              if (length15 == 0)
                charInMap.cdir = charInMap.cx > char5.cx ? -1 : 1;
            }
            if (length15 > 0)
            {
              charInMap.attChars = new Char[length15];
              for (int index23 = 0; index23 < charInMap.attChars.Length; ++index23)
                charInMap.attChars[index23] = charArray[index23];
          ...
          try
          {
            ...
            if (num60 == (sbyte) 1)
            {
              ...
              if (charId6 == Char.myCharz().charID)
              {
                ...
                char1.isDie = msg.reader().readBoolean();
                if (char1.isDie)
                  Char.isLockKey = true;
                Res.outz("isDie=" + (object) char1.isDie + "---------------------------------------");
                int num63 = 0;
                ...
                if (num61 == (sbyte) 0)
                {
                  char1.doInjure(HPShow, 0, isCrit, false);
                  goto case 41;
                }
                else
                  goto case 41;
              ...
              {
                char1 = GameScr.findCharInMap(charId6);
                if (char1 == null)
                  break;
...
label_919:
          ...
          switch ((int) command2 + 17)
          {
            ...
            case 4:
              ...
              int index24 = (int) msg.reader().readUnsignedByte();
              if (index24 > GameScr.vMob.size() - 1 || index24 < 0)
                return;
              Mob mob2 = (Mob) GameScr.vMob.elementAt(index24);
            ...
            case 5:
              ...
              if (mob3 != null && mob3.status != 0 && mob3.status != 0)
              {
                ...
                try
                {
                  ...
                  for (int index25 = 0; index25 < (int) num67; ++index25)
                  {
            ...
            case 6:
              ...
              try
              {
                int index26 = (int) msg.reader().readUnsignedByte();
                mob4 = (Mob) GameScr.vMob.elementAt(index26);
              }
              catch (Exception ex)
              {
                Res.outz("Loi tai NPC_ATTACK_ME " + (object) msg.command + " err= " + ex.StackTrace);
              }
              if (mob4 != null)
              {
            ...
            case 10:
              ...
              for (int index27 = 0; index27 < GameScr.vCharInMap.size(); ++index27)
              {
                Char char6 = (Char) null;
                try
                {
                  char6 = (Char) GameScr.vCharInMap.elementAt(index27);
                }
                catch (Exception ex)
                {
                ...
                if (char6 != null)
                {
                  if (char6.charID == num71)
                  {
                    GameCanvas.debug("SA8x2y" + (object) index27, 2);
                    char6.moveTo((int) msg.reader().readShort(), (int) msg.reader().readShort(), 0);
                    char6.lastUpdateTime = mSystem.currentTimeMillis();
                    break;
                  }
                }
                else
            ...
            case 11:
              ...
              for (int index28 = 0; index28 < GameScr.vCharInMap.size(); ++index28)
              {
                Char char7 = (Char) GameScr.vCharInMap.elementAt(index28);
                if (char7 != null && char7.charID == num72)
                {
                  if (!char7.isInvisiblez && !char7.isUsePlane)
                    ServerEffect.addServerEffect(60, char7.cx, char7.cy, 1);
                  if (char7.isUsePlane)
                    return;
                  GameScr.vCharInMap.removeElementAt(index28);
                  return;
                }
              }
              break;
            case 12:
              ...
              if (char8.clanID == -2)
                char8.isCopy = true;
              if (this.readCharInfo(char8, msg))
              {
                sbyte num75 = msg.reader().readByte();
                if (char8.cy <= 10 && num75 != (sbyte) 0 && num75 != (sbyte) 2)
                {
                  Res.outz("nhân vật bay trên trời xuống x= " + (object) char8.cx + " y= " + (object) char8.cy);
                  Teleport p = new Teleport(char8.cx, char8.cy, char8.head, char8.cdir, 1, false, num75 != (sbyte) 1 ? (int) num75 : char8.cgender);
                  p.id = char8.charID;
                ...
                if (num75 == (sbyte) 2)
                  char8.show();
                for (int index29 = 0; index29 < GameScr.vMob.size(); ++index29)
                {
                  Mob mob7 = (Mob) GameScr.vMob.elementAt(index29);
                  if (mob7 != null && mob7.isMobMe && mob7.mobId == char8.charID)
                  {
                ...
                if (GameScr.findCharInMap(char8.charID) == null)
                  GameScr.vCharInMap.addElement((object) char8);
              ...
              char8.cFlag = num77;
              char8.isNhapThe = msg.reader().readByte() == (sbyte) 1;
              try
              {
                char8.idAuraEff = msg.reader().readShort();
                char8.idEff_Set_Item = (short) msg.reader().readSByte();
                char8.idHat = msg.reader().readShort();
                if (char8.bag >= 201 && char8.bag < (int) byte.MaxValue)
                {
                  char8.addEffChar(new Effect(char8.bag, char8, 2, -1, 10, (sbyte) 1)
                  {
                    typeEff = 5
                  });
                }
                ...
                {
                  for (int index30 = 0; index30 < 54; ++index30)
                    char8.removeEffChar(0, 201 + index30);
                }
              }
              catch (Exception ex)
              {
                Res.outz("cmd: -5 err: " + ex.StackTrace);
              }
              GameScr.gI().getFlagImage(char8.charID, char8.cFlag);
              Res.outz("Cmd: -5 PLAYER_ADD: cID| cName| cFlag| cBag|    " + (object) char1.charID + " | " + char1.cName + " | " + (object) char1.cFlag + " | " + (object) char1.bag);
              break;
            case 14:
            ...
            default:
              switch (command2)
              {
                ...
                case 97:
                  ...
                  for (int index31 = 0; index31 < Char.myCharz().taskOrders.size(); ++index31)
                  {
                    TaskOrder taskOrder = (TaskOrder) Char.myCharz().taskOrders.elementAt(index31);
                ...
                default:
                  switch ((int) command2 + 75)
                  {
                    ...
                    case 2:
                      ...
                      for (int index32 = 0; index32 < GameScr.vNpc.size(); ++index32)
                      {
                        Npc npc = (Npc) GameScr.vNpc.elementAt(index32);
                    ...
                    default:
                      switch (command2)
                      {
                        case 18:
                          ...
                          for (int index33 = 0; index33 < (int) num85; ++index33)
                          {
                        ...
                        case 44:
                          ...
                          Char char9 = Char.myCharz().charID != charId8 ? GameScr.findCharInMap(charId8) : Char.myCharz();
                          if (char9 == null)
                            return;
                          char9.addInfo(info1);
                          break;
        ...
        case 46:
          ...
          for (int index34 = 0; index34 < Char.myCharz().clan.currMember; ++index34)
          ...
          for (int index35 = 0; index35 < num90; ++index35)
        ...
        case 47:
          ...
          if (num91 == (sbyte) 2)
          {
            ...
            for (int index36 = 0; index36 < GameCanvas.panel.myMember.size(); ++index36)
            {
              Member o1 = (Member) GameCanvas.panel.myMember.elementAt(index36);
              if (o1.ID == member.ID)
              {
                ...
                GameCanvas.panel.myMember.insertElementAt((object) o2, index36);
                return;
              }
            }
          }
        ...
        case 49:
          ...
          for (int index37 = 0; index37 < (int) num92; ++index37)
        ...
        case 52:
          InfoDlg.hide();
          sbyte length16 = msg.reader().readByte();
          Res.outz("clan = " + (object) length16);
          if (length16 == (sbyte) 0)
          {
          ...
          {
            GameCanvas.panel.clans = new Clan[(int) length16];
            Res.outz("clan search lent= " + (object) GameCanvas.panel.clans.Length);
            for (int index38 = 0; index38 < GameCanvas.panel.clans.Length; ++index38)
            {
              GameCanvas.panel.clans[index38] = new Clan();
              GameCanvas.panel.clans[index38].ID = msg.reader().readInt();
              GameCanvas.panel.clans[index38].name = msg.reader().readUTF();
              GameCanvas.panel.clans[index38].slogan = msg.reader().readUTF();
              GameCanvas.panel.clans[index38].imgID = (int) msg.reader().readUnsignedByte();
              GameCanvas.panel.clans[index38].powerPoint = msg.reader().readUTF();
              GameCanvas.panel.clans[index38].leaderName = msg.reader().readUTF();
              GameCanvas.panel.clans[index38].currMember = (int) msg.reader().readUnsignedByte();
              GameCanvas.panel.clans[index38].maxMember = (int) msg.reader().readUnsignedByte();
              GameCanvas.panel.clans[index38].date = msg.reader().readInt();
            }
          }
        ...
        case 53:
          ...
          if (num93 == (sbyte) 1 || num93 == (sbyte) 3)
          {
            ...
            for (int index39 = 0; index39 < num94; ++index39)
            {
              ...
              {
                ClanImage.getClanImage((short) cm.ID).name = cm.name;
                ClanImage.getClanImage((short) cm.ID).xu = cm.xu;
                ClanImage.getClanImage((short) cm.ID).luong = cm.luong;
              }
            }
            if (Char.myCharz().clan != null)
        ...
        case 54:
          ...
          short idskillPaint = msg.reader().readShort();
          Res.outz(">.SKILL_NOT_FOCUS  skill type= " + (object) num95 + "   player use= " + (object) charId9);
          if (num95 == (sbyte) 20)
          {
            sbyte typeFrame = msg.reader().readByte();
            sbyte dir = msg.reader().readByte();
            short timeGong = msg.reader().readShort();
            bool isFly = msg.reader().readByte() != (sbyte) 0;
            ...
            Res.outz(">.SKILL_NOT_FOCUS  skill playerDir= " + (object) dir);
            char1 = Char.myCharz().charID != charId9 ? GameScr.findCharInMap(charId9) : Char.myCharz();
            char1.SetSkillPaint_NEW(idskillPaint, isFly, typeFrame, typePaint, dir, timeGong, typeItem);
          }
          if (num95 == (sbyte) 21)
          {
            Point targetDame = new Point();
            targetDame.x = (int) msg.reader().readShort();
            targetDame.y = (int) msg.reader().readShort();
            short timeDame = msg.reader().readShort();
            short rangeDame = msg.reader().readShort();
            sbyte typePaint = 0;
            sbyte typeItem = -1;
            Point[] listObj = (Point[]) null;
            char1 = Char.myCharz().charID != charId9 ? GameScr.findCharInMap(charId9) : Char.myCharz();
            try
            {
              typePaint = msg.reader().readByte();
              listObj = new Point[(int) msg.reader().readByte()];
              for (int index40 = 0; index40 < listObj.Length; ++index40)
              {
                listObj[index40] = new Point();
                listObj[index40].type = msg.reader().readByte();
                listObj[index40].id = listObj[index40].type != (sbyte) 0 ? msg.reader().readInt() : (int) msg.reader().readByte();
              }
            }
            catch (Exception ex)
            {
            ...
            Res.outz(">.SKILL_NOT_FOCUS  skill targetDame= " + (object) targetDame.x + ":" + (object) targetDame.y + "    c:" + (object) char1.cx + ":" + (object) char1.cy + "   cdir:" + (object) char1.cdir);
            char1.SetSkillPaint_STT(1, idskillPaint, targetDame, timeDame, rangeDame, typePaint, listObj, typeItem);
          }
          if (num95 == (sbyte) 0)
          {
            ...
            {
              char1 = GameScr.findCharInMap(charId9);
              if ((TileMap.tileTypeAtPixel(char1.cx, char1.cy) & 2) == 2)
              {
                char1.setSkillPaint(GameScr.sks[(int) idskillPaint], 0);
              }
              else
              {
                char1.setSkillPaint(GameScr.sks[(int) idskillPaint], 1);
                char1.delayFall = 20;
              }
            }
            else
            ...
            for (int index41 = 0; index41 < (int) num96; ++index41)
            {
              sbyte index42 = msg.reader().readByte();
              sbyte num97 = msg.reader().readByte();
              Res.outz("index= " + (object) index42);
              if (idskillPaint >= (short) 42 && idskillPaint <= (short) 48)
              {
                ((Mob) GameScr.vMob.elementAt((int) index42)).isFreez = true;
                ((Mob) GameScr.vMob.elementAt((int) index42)).seconds = (int) num97;
                ((Mob) GameScr.vMob.elementAt((int) index42)).last = ((Mob) GameScr.vMob.elementAt((int) index42)).cur = mSystem.currentTimeMillis();
              }
            }
            sbyte num98 = msg.reader().readByte();
            for (int index43 = 0; index43 < (int) num98; ++index43)
            {
              ...
              if (idskillPaint >= (short) 42 && idskillPaint <= (short) 48)
              {
                ...
                {
                  char1 = GameScr.findCharInMap(charId10);
                  if (char1 != null && !char1.isFlyAndCharge && !char1.isStandAndCharge)
                  {
                    char1.isFreez = true;
                    char1.seconds = (int) num99;
                    char1.freezSeconds = (int) num99;
                    char1.lastFreez = GameScr.findCharInMap(charId10).currFreez = mSystem.currentTimeMillis();
                  }
                }
              }
            }
          ...
          if (num95 == (sbyte) 4)
          {
            ...
            else if (GameScr.findCharInMap(charId9) != null)
            {
              ...
              GameScr.findCharInMap(charId9).skillTemplateId = (int) idskillPaint;
          ...
          {
            if (charId9 == Char.myCharz().charID)
              Char.myCharz().setAutoSkillPaint(GameScr.sks[(int) idskillPaint], 0);
            else if (GameScr.findCharInMap(charId9) != null)
            {
              GameScr.findCharInMap(charId9).setAutoSkillPaint(GameScr.sks[(int) idskillPaint], 0);
              SoundMn.gI().gong();
            }
          }
          if (num95 == (sbyte) 7)
        ...
        case 55:
          ...
          Char.myCharz().arrItemShop = new Item[length17][];
          GameCanvas.panel.shopTabName = new string[length17 + (flag4 ? 0 : 1)][];
          for (int index44 = 0; index44 < GameCanvas.panel.shopTabName.Length; ++index44)
            GameCanvas.panel.shopTabName[index44] = new string[2];
          if (typeShop == (sbyte) 2)
          {
            GameCanvas.panel.maxPageShop = new int[length17];
            GameCanvas.panel.currPageShop = new int[length17];
          }
          if (!flag4)
            GameCanvas.panel.shopTabName[length17] = mResources.inventory;
          for (int index45 = 0; index45 < length17; ++index45)
          {
            string[] strArray = Res.split(msg.reader().readUTF(), "\n", 0);
            if (typeShop == (sbyte) 2)
              GameCanvas.panel.maxPageShop[index45] = (int) msg.reader().readUnsignedByte();
            if (strArray.Length == 2)
              GameCanvas.panel.shopTabName[index45] = strArray;
            if (strArray.Length == 1)
            {
              GameCanvas.panel.shopTabName[index45][0] = strArray[0];
              GameCanvas.panel.shopTabName[index45][1] = string.Empty;
            }
            int length18 = (int) msg.reader().readUnsignedByte();
            Char.myCharz().arrItemShop[index45] = new Item[length18];
            Panel.strWantToBuy = mResources.say_wat_do_u_want_to_buy;
            if (typeShop == (sbyte) 1)
              Panel.strWantToBuy = mResources.say_wat_do_u_want_to_buy2;
            for (int index46 = 0; index46 < length18; ++index46)
            {
              short id3 = msg.reader().readShort();
              if (id3 != (short) -1)
              {
                Char.myCharz().arrItemShop[index45][index46] = new Item();
                Char.myCharz().arrItemShop[index45][index46].template = ItemTemplates.get(id3);
                Res.outz("name " + (object) index45 + " = " + Char.myCharz().arrItemShop[index45][index46].template.name + " id templat= " + (object) Char.myCharz().arrItemShop[index45][index46].template.id);
                switch (typeShop)
                {
                  case 0:
                    Char.myCharz().arrItemShop[index45][index46].buyCoin = msg.reader().readInt();
                    Char.myCharz().arrItemShop[index45][index46].buyGold = msg.reader().readInt();
                    break;
                  case 1:
                    Char.myCharz().arrItemShop[index45][index46].powerRequire = msg.reader().readLong();
                    break;
                  case 2:
                    Char.myCharz().arrItemShop[index45][index46].itemId = (int) msg.reader().readShort();
                    Char.myCharz().arrItemShop[index45][index46].buyCoin = msg.reader().readInt();
                    Char.myCharz().arrItemShop[index45][index46].buyGold = msg.reader().readInt();
                    Char.myCharz().arrItemShop[index45][index46].buyType = msg.reader().readByte();
                    Char.myCharz().arrItemShop[index45][index46].quantity = msg.reader().readInt();
                    Char.myCharz().arrItemShop[index45][index46].isMe = msg.reader().readByte();
                    break;
                  case 3:
                    Char.myCharz().arrItemShop[index45][index46].isBuySpec = true;
                    Char.myCharz().arrItemShop[index45][index46].iconSpec = msg.reader().readShort();
                    Char.myCharz().arrItemShop[index45][index46].buySpec = msg.reader().readInt();
                    break;
                  case 4:
                    Char.myCharz().arrItemShop[index45][index46].reason = msg.reader().readUTF();
                    break;
                  case 8:
                    Char.myCharz().arrItemShop[index45][index46].buyCoin = msg.reader().readInt();
                    Char.myCharz().arrItemShop[index45][index46].buyGold = msg.reader().readInt();
                ...
                if (length19 != 0)
                {
                  Char.myCharz().arrItemShop[index45][index46].itemOption = new ItemOption[length19];
                  for (int index47 = 0; index47 < Char.myCharz().arrItemShop[index45][index46].itemOption.Length; ++index47)
                  {
                    int optionTemplateId = (int) msg.reader().readUnsignedByte();
                    int num100 = (int) msg.reader().readUnsignedShort();
                    if (optionTemplateId != -1)
                    {
                      Char.myCharz().arrItemShop[index45][index46].itemOption[index47] = new ItemOption(optionTemplateId, num100);
                      Char.myCharz().arrItemShop[index45][index46].compare = GameCanvas.panel.getCompare(Char.myCharz().arrItemShop[index45][index46]);
                    }
                  }
                }
                sbyte num101 = msg.reader().readByte();
                Char.myCharz().arrItemShop[index45][index46].newItem = num101 != (sbyte) 0;
                if (msg.reader().readByte() == (sbyte) 1)
                {
                  ...
                  Char.myCharz().arrItemShop[index45][index46].setPartTemp(headTemp, bodyTemp, legTemp, bagTemp);
                }
              }
            }
          }
        ...
        case 56:
          ...
          sbyte index48 = msg.reader().readByte();
          string info2 = msg.reader().readUTF();
          GameCanvas.panel.itemRequest(itemAction, info2, where, index48);
          goto case 41;
        case 57:
          ...
          goto case 41;
        case 58:
          sbyte length20 = msg.reader().readByte();
          Char.myCharz().strLevel = new string[(int) length20];
          for (int index49 = 0; index49 < (int) length20; ++index49)
          {
            string str4 = msg.reader().readUTF();
            Char.myCharz().strLevel[index49] = str4;
          }
        ...
        case 62:
          ...
          if (num102 == (sbyte) 0)
          {
            ...
            Res.outz("num body = " + (object) length21);
            Char.myCharz().arrItemBody = new Item[length21];
            for (int index50 = 0; index50 < length21; ++index50)
            {
              short id4 = msg.reader().readShort();
              if (id4 != (short) -1)
              {
                Char.myCharz().arrItemBody[index50] = new Item();
                Char.myCharz().arrItemBody[index50].template = ItemTemplates.get(id4);
                int type = (int) Char.myCharz().arrItemBody[index50].template.type;
                Char.myCharz().arrItemBody[index50].quantity = msg.reader().readInt();
                Char.myCharz().arrItemBody[index50].info = msg.reader().readUTF();
                Char.myCharz().arrItemBody[index50].content = msg.reader().readUTF();
                int length22 = (int) msg.reader().readUnsignedByte();
                if (length22 != 0)
                {
                  Char.myCharz().arrItemBody[index50].itemOption = new ItemOption[length22];
                  for (int index51 = 0; index51 < Char.myCharz().arrItemBody[index50].itemOption.Length; ++index51)
                  {
                    int optionTemplateId = (int) msg.reader().readUnsignedByte();
                    int num103 = (int) msg.reader().readUnsignedShort();
                    if (optionTemplateId != -1)
                      Char.myCharz().arrItemBody[index50].itemOption[index51] = new ItemOption(optionTemplateId, num103);
                  }
                }
                switch (type)
                {
                  case 0:
                    Char.myCharz().body = (int) Char.myCharz().arrItemBody[index50].template.part;
                    continue;
                  case 1:
                    Char.myCharz().leg = (int) Char.myCharz().arrItemBody[index50].template.part;
                    continue;
                  default:
                    continue;
                }
        ...
        case 63:
          ...
          if (num104 == (sbyte) 0)
          {
            ...
            Char.myCharz().arrItemBag = new Item[length23];
            GameScr.hpPotion = 0;
            Res.outz("numC=" + (object) length23);
            for (int index52 = 0; index52 < length23; ++index52)
            {
              short id5 = msg.reader().readShort();
              if (id5 != (short) -1)
              {
                Char.myCharz().arrItemBag[index52] = new Item();
                Char.myCharz().arrItemBag[index52].template = ItemTemplates.get(id5);
                Char.myCharz().arrItemBag[index52].quantity = msg.reader().readInt();
                Char.myCharz().arrItemBag[index52].info = msg.reader().readUTF();
                Char.myCharz().arrItemBag[index52].content = msg.reader().readUTF();
                Char.myCharz().arrItemBag[index52].indexUI = index52;
                int length24 = (int) msg.reader().readUnsignedByte();
                if (length24 != 0)
                {
                  Char.myCharz().arrItemBag[index52].itemOption = new ItemOption[length24];
                  for (int index53 = 0; index53 < Char.myCharz().arrItemBag[index52].itemOption.Length; ++index53)
                  {
                    int optionTemplateId = (int) msg.reader().readUnsignedByte();
                    int num105 = (int) msg.reader().readUnsignedShort();
                    if (optionTemplateId != -1)
                      Char.myCharz().arrItemBag[index52].itemOption[index53] = new ItemOption(optionTemplateId, num105);
                  }
                  Char.myCharz().arrItemBag[index52].compare = GameCanvas.panel.getCompare(Char.myCharz().arrItemBag[index52]);
                }
                if (Char.myCharz().arrItemBag[index52].template.type != (sbyte) 11)
                  ;
                if (Char.myCharz().arrItemBag[index52].template.type == (sbyte) 6)
                  GameScr.hpPotion += Char.myCharz().arrItemBag[index52].quantity;
              }
            }
          }
          if (num104 == (sbyte) 2)
          {
            sbyte index54 = msg.reader().readByte();
            int num106 = msg.reader().readInt();
            int quantity = Char.myCharz().arrItemBag[(int) index54].quantity;
            Char.myCharz().arrItemBag[(int) index54].quantity = num106;
            if (Char.myCharz().arrItemBag[(int) index54].quantity < quantity && Char.myCharz().arrItemBag[(int) index54].template.type == (sbyte) 6)
              GameScr.hpPotion -= quantity - Char.myCharz().arrItemBag[(int) index54].quantity;
            if (Char.myCharz().arrItemBag[(int) index54].quantity == 0)
            {
              Char.myCharz().arrItemBag[(int) index54] = (Item) null;
              goto case 41;
            }
            else
              goto case 41;
        ...
        case 64:
          ...
          if (num107 == (sbyte) 0)
          {
            int length25 = (int) msg.reader().readUnsignedByte();
            Char.myCharz().arrItemBox = new Item[length25];
            GameCanvas.panel.hasUse = 0;
            for (int index55 = 0; index55 < length25; ++index55)
            {
              short id6 = msg.reader().readShort();
              if (id6 != (short) -1)
              {
                Char.myCharz().arrItemBox[index55] = new Item();
                Char.myCharz().arrItemBox[index55].template = ItemTemplates.get(id6);
                Char.myCharz().arrItemBox[index55].quantity = msg.reader().readInt();
                Char.myCharz().arrItemBox[index55].info = msg.reader().readUTF();
                Char.myCharz().arrItemBox[index55].content = msg.reader().readUTF();
                int length26 = (int) msg.reader().readUnsignedByte();
                if (length26 != 0)
                {
                  Char.myCharz().arrItemBox[index55].itemOption = new ItemOption[length26];
                  for (int index56 = 0; index56 < Char.myCharz().arrItemBox[index55].itemOption.Length; ++index56)
                  {
                    int optionTemplateId = (int) msg.reader().readUnsignedByte();
                    int num108 = (int) msg.reader().readUnsignedShort();
                    if (optionTemplateId != -1)
                      Char.myCharz().arrItemBox[index55].itemOption[index56] = new ItemOption(optionTemplateId, num108);
                  }
                }
          ...
          if (num107 == (sbyte) 2)
          {
            sbyte index57 = msg.reader().readByte();
            int num109 = msg.reader().readInt();
            Char.myCharz().arrItemBox[(int) index57].quantity = num109;
            if (Char.myCharz().arrItemBox[(int) index57].quantity == 0)
            {
              Char.myCharz().arrItemBox[(int) index57] = (Item) null;
              goto case 41;
            }
            else
              goto case 41;
        ...
        case 65:
          ...
          if (num110 == (sbyte) 0 && GameScr.gI().magicTree != null)
          {
            ...
            sbyte length27 = msg.reader().readByte();
            magicTree.peaPostionX = new int[(int) length27];
            magicTree.peaPostionY = new int[(int) length27];
            for (int index58 = 0; index58 < (int) length27; ++index58)
            {
              magicTree.peaPostionX[index58] = (int) msg.reader().readByte();
              magicTree.peaPostionY[index58] = (int) msg.reader().readByte();
            }
        ...
        case 67:
          ...
          try
          {
            numArray3 = new sbyte[lenght1];
            for (int index59 = 0; index59 < lenght1; ++index59)
              numArray3[index59] = msg.reader().readByte();
            image1 = Image.createImage(numArray3, 0, lenght1);
            BgItem.imgNew.put((object) (id7.ToString() + string.Empty), (object) image1);
          }
          catch (Exception ex)
          {
            numArray3 = (sbyte[]) null;
            BgItem.imgNew.put((object) (id7.ToString() + string.Empty), (object) Image.createRGBImage(new int[1], 1, 1, true));
          }
          if (numArray3 != null)
          {
            if (mGraphics.zoomLevel > 1)
              Rms.saveRMS(mGraphics.zoomLevel.ToString() + "bgItem" + (object) id7, numArray3);
        ...
        case 68:
          ...
          for (int index60 = 0; index60 < (int) num111; ++index60)
          {
            BgItem o = new BgItem();
            o.id = index60;
            ...
            sbyte length28 = msg.reader().readByte();
            o.tileX = new int[(int) length28];
            o.tileY = new int[(int) length28];
            for (int index61 = 0; index61 < (int) length28; ++index61)
            {
              o.tileX[index60] = (int) msg.reader().readByte();
              o.tileY[index60] = (int) msg.reader().readByte();
            }
        ...
        case 78:
          ...
          for (int index62 = 0; index62 < GameScr.vItemMap.size(); ++index62)
          {
            if (((ItemMap) GameScr.vItemMap.elementAt(index62)).itemMapID == (int) num112)
            {
              GameScr.vItemMap.removeElementAt(index62);
              break;
            }
          }
          goto case 41;
        case 79:
          ...
          for (int index63 = 0; index63 < GameScr.vItemMap.size(); ++index63)
          {
            ItemMap itemMap = (ItemMap) GameScr.vItemMap.elementAt(index63);
        ...
        case 80:
          ...
          char1 = GameScr.findCharInMap(msg.reader().readInt());
          for (int index64 = 0; index64 < GameScr.vItemMap.size(); ++index64)
          {
            ItemMap itemMap = (ItemMap) GameScr.vItemMap.elementAt(index64);
            if (itemMap.itemMapID == (int) num115)
            {
              if (char1 == null)
                return;
              itemMap.setPoint(char1.cx, char1.cy - 10);
              if (itemMap.x < char1.cx)
              {
                char1.cdir = -1;
                break;
              }
        ...
        case 81:
          ...
          int index65 = (int) msg.reader().readByte();
          GameScr.vItemMap.addElement((object) new ItemMap(msg.reader().readShort(), Char.myCharz().arrItemBag[index65].template.id, Char.myCharz().cx, Char.myCharz().cy, (int) msg.reader().readShort(), (int) msg.reader().readShort()));
          Char.myCharz().arrItemBag[index65] = (Item) null;
          goto case 41;
        case 85:
          ...
          if (char1 == null)
            break;
          GameScr.vItemMap.addElement((object) new ItemMap(msg.reader().readShort(), msg.reader().readShort(), char1.cx, char1.cy, (int) msg.reader().readShort(), (int) msg.reader().readShort()));
          goto case 41;
        case 95:
          ...
          if ((TileMap.tileTypeAtPixel(char1.cx, char1.cy) & 2) == 2)
            char1.setSkillPaint(GameScr.sks[(int) msg.reader().readUnsignedByte()], 0);
          else
            char1.setSkillPaint(GameScr.sks[(int) msg.reader().readUnsignedByte()], 1);
          GameCanvas.debug("SA76v2", 2);
          char1.attMobs = new Mob[(int) msg.reader().readByte()];
          for (int index66 = 0; index66 < char1.attMobs.Length; ++index66)
          {
            Mob mob11 = (Mob) GameScr.vMob.elementAt((int) msg.reader().readByte());
            char1.attMobs[index66] = mob11;
            if (index66 == 0)
              char1.cdir = char1.cx > mob11.x ? -1 : 1;
          }
          GameCanvas.debug("SA76v3", 2);
          char1.charFocus = (Char) null;
          char1.mobFocus = char1.attMobs[0];
          Char[] charArray1 = new Char[10];
          int length29 = 0;
          try
          {
            for (length29 = 0; length29 < charArray1.Length; ++length29)
            {
              int charId11 = msg.reader().readInt();
              Char char10 = charId11 != Char.myCharz().charID ? GameScr.findCharInMap(charId11) : Char.myCharz();
              charArray1[length29] = char10;
              if (length29 == 0)
                char1.cdir = char1.cx > char10.cx ? -1 : 1;
            }
          }
          catch (Exception ex)
          {
          ...
          if (length29 > 0)
          {
            char1.attChars = new Char[length29];
            for (int index67 = 0; index67 < char1.attChars.Length; ++index67)
              char1.attChars[index67] = charArray1[index67];
            char1.charFocus = char1.attChars[0];
            char1.mobFocus = (Mob) null;
          }
        ...
        case 110:
          ...
          for (int index68 = 0; index68 < GameScr.vMob.size(); ++index68)
          {
            Mob mob12 = (Mob) GameScr.vMob.elementAt(index68);
        ...
        case 126:
          ...
          for (int index69 = 0; index69 < num117; ++index69)
          {
            string caption = msg.reader().readUTF();
        ...
        case 131:
          ...
          {
            Npc npc = (Npc) GameScr.vNpc.elementAt(index70);
            if (npc.template.npcTemplateId == num118 && npc.Equals((object) Char.myCharz().npcFocus))
            {
              ...
              for (int index71 = 0; index71 < menu.Length; ++index71)
                menu[index71] = msg.reader().readUTF();
          ...
          for (int index72 = 0; index72 < menu1.Length; ++index72)
            menu1[index72] = msg.reader().readUTF();
          try
          {
        ...
        case 132:
          ...
          if (Char.myCharz().npcFocus == null)
            break;
          for (int index73 = 0; index73 < Char.myCharz().npcFocus.template.menu.Length; ++index73)
          {
            string[] p = Char.myCharz().npcFocus.template.menu[index73];
        ...
        case 137:
          ...
          for (int index74 = 0; index74 < GameScr.vNpc.size(); ++index74)
          {
            Npc c2 = (Npc) GameScr.vNpc.elementAt(index74);
        ...
        case 139:
          ...
          sbyte index75 = msg.reader().readByte();
          ...
          short count = -1;
          for (int index76 = 0; index76 < subNames.Length; ++index76)
          {
            string str5 = Res.changeString(msg.reader().readUTF());
            GameScr.tasks[index76] = (int) msg.reader().readByte();
            GameScr.mapTasks[index76] = (int) msg.reader().readShort();
            string str6 = Res.changeString(msg.reader().readUTF());
            counts[index76] = (short) -1;
            if (!str5.Equals(string.Empty))
            {
              subNames[index76] = str5;
              contentInfo[index76] = str6;
            }
          }
          try
          {
            count = msg.reader().readShort();
            for (int index77 = 0; index77 < subNames.Length; ++index77)
              counts[index77] = msg.reader().readShort();
          }
          catch (Exception ex)
          {
            Cout.println("Loi TASK_GET " + ex.ToString());
          }
          Char.myCharz().taskMaint = new Task(taskId, index75, name, detail, subNames, counts, count, contentInfo);
          if (Char.myCharz().npcFocus != null)
            Npc.clearEffTask();
        ...
        case 142:
          ...
          try
          {
            ...
            Char.myCharz().x_hint = num121;
            Char.myCharz().y_hint = num122;
            Res.outz("CMD   TASK_UPDATE:43_mapID =    x|y " + (object) num121 + "|" + (object) num122);
            for (int index78 = 0; index78 < TileMap.vGo.size(); ++index78)
              Res.outz("===> " + TileMap.vGo.elementAt(index78));
            goto case 41;
          }
          catch (Exception ex)
          {
        ...
        case 146:
          ...
          goto case 41;
        case 149:
          sbyte num123 = msg.reader().readByte();
          Panel.vGameInfo.removeAllElements();
          for (int index79 = 0; index79 < (int) num123; ++index79)
          {
        ...
        case 153:
          ...
          if (char1 == null)
            break;
          int index80 = (int) msg.reader().readUnsignedByte();
          if ((TileMap.tileTypeAtPixel(char1.cx, char1.cy) & 2) == 2)
            char1.setSkillPaint(GameScr.sks[index80], 0);
          else
            char1.setSkillPaint(GameScr.sks[index80], 1);
          Mob[] mobArray = new Mob[10];
          int length30 = 0;
          try
          {
            for (length30 = 0; length30 < mobArray.Length; ++length30)
            {
              Mob mob13 = (Mob) GameScr.vMob.elementAt((int) msg.reader().readByte());
              mobArray[length30] = mob13;
              if (length30 == 0)
                char1.cdir = char1.cx > mob13.x ? -1 : 1;
            }
          }
          catch (Exception ex)
          {
          ...
          if (length30 > 0)
          {
            char1.attMobs = new Mob[length30];
            for (int index81 = 0; index81 < char1.attMobs.Length; ++index81)
              char1.attMobs[index81] = mobArray[index81];
            char1.charFocus = (Char) null;
            char1.mobFocus = char1.attMobs[0];
            goto case 41;
          }
        ...
        case 155:
          ...
          if (charId12 == Char.myCharz().charID)
          {
            bool flag8 = false;
            char1 = Char.myCharz();
            char1.cHP = msg.readInt3Byte();
            int num124 = msg.readInt3Byte();
            Res.outz("dame hit = " + (object) num124);
            if (num124 != 0)
              char1.doInjure();
            int num125 = 0;
            try
            {
              ...
              if (id9 != (sbyte) -1)
              {
                ...
                EffecMn.addEff(new Effect((int) id9, char1.cx, char1.cy, 3, 1, -1));
              }
            }
            catch (Exception ex)
            {
            ...
            if (Char.myCharz().cTypePk != (sbyte) 4)
            {
              if (num126 == 0)
              {
                GameScr.startFlyText(mResources.miss, char1.cx, char1.cy - char1.ch, 0, -3, mFont.MISS_ME);
                goto case 41;
              }
              else
              {
                GameScr.startFlyText("-" + (object) num126, char1.cx, char1.cy - char1.ch, 0, -3, flag8 ? mFont.FATAL : mFont.RED);
                goto case 41;
              }
            }
            else
          ...
          {
            char1 = GameScr.findCharInMap(charId12);
            if (char1 == null)
              break;
            char1.cHP = msg.readInt3Byte();
            bool flag9 = false;
            int num127 = msg.readInt3Byte();
            if (num127 != 0)
              char1.doInjure();
            int num128 = 0;
            try
            {
              ...
              if (id10 != (sbyte) -1)
              {
                ...
                EffecMn.addEff(new Effect((int) id10, char1.cx, char1.cy, 3, 1, -1));
              }
            }
            catch (Exception ex)
            {
            }
            int num129 = num127 + num128;
            if (char1.cTypePk != (sbyte) 4)
            {
              if (num129 == 0)
              {
                GameScr.startFlyText(mResources.miss, char1.cx, char1.cy - char1.ch, 0, -3, mFont.MISS);
                goto case 41;
              }
              else
              {
                GameScr.startFlyText("-" + (object) num129, char1.cx, char1.cy - char1.ch, 0, -3, flag9 ? mFont.FATAL : mFont.ORANGE);
                goto case 41;
              }
            }
            else
        ...
        case 157:
          ...
          Char char11 = charId13 != Char.myCharz().charID ? GameScr.findCharInMap(charId13) : Char.myCharz();
          char11.moveFast = new short[3];
          char11.moveFast[0] = (short) 0;
          short num130 = msg.reader().readShort();
          short num131 = msg.reader().readShort();
          char11.moveFast[1] = num130;
          char11.moveFast[2] = num131;
          try
          {
            int charId14 = msg.reader().readInt();
            Char char12 = charId14 != Char.myCharz().charID ? GameScr.findCharInMap(charId14) : Char.myCharz();
            char12.cx = (int) num130;
            char12.cy = (int) num131;
            goto case 41;
          }
          catch (Exception ex)
          {
        ...
        case 161:
          ...
          if (char1 != null)
          {
            char1.killCharId = Char.myCharz().charID;
            Char.myCharz().npcFocus = (Npc) null;
            Char.myCharz().mobFocus = (Mob) null;
            Char.myCharz().itemFocus = (ItemMap) null;
            Char.myCharz().charFocus = char1;
            Char.isManualFocus = true;
            GameScr.info1.addInfo(char1.cName + mResources.CUU_SAT, 0);
            goto case 41;
          }
          else
            goto case 41;
        ...
        case 182:
          ...
          char1 = charId15 != Char.myCharz().charID ? GameScr.findCharInMap(charId15) : Char.myCharz();
          if (char1 == null)
            break;
          Mob mobToAttack = (Mob) GameScr.vMob.elementAt((int) msg.reader().readUnsignedByte());
          if (char1.mobMe != null)
          {
            char1.mobMe.attackOtherMob(mobToAttack);
            goto case 41;
          }
          else
            goto case 41;
        case 183:
          ...
          {
            char1 = GameScr.findCharInMap(charId16);
            if (char1 == null)
              break;
          }
          char1.cHP = char1.cHPFull;
          char1.cMP = char1.cMPFull;
          char1.cx = (int) msg.reader().readShort();
          char1.cy = (int) msg.reader().readShort();
          char1.liveFromDead();
          goto case 41;
        case 184:
          GameCanvas.debug("SXX5", 2);
        ...
        case 191:
          ...
          {
            GameScr.info2.addInfoWithChar(s1, c4, num132 == (sbyte) 0);
        ...
        case 211:
          ...
          Res.outz("spec type= " + (object) num133);
          switch (num133)
          {
            case 0:
              ...
              goto label_919;
            case 1:
              sbyte length31 = msg.reader().readByte();
              Char.myCharz().infoSpeacialSkill = new string[(int) length31][];
              Char.myCharz().imgSpeacialSkill = new short[(int) length31][];
              GameCanvas.panel.speacialTabName = new string[(int) length31][];
              for (int index82 = 0; index82 < (int) length31; ++index82)
              {
                GameCanvas.panel.speacialTabName[index82] = new string[2];
                string[] strArray = Res.split(msg.reader().readUTF(), "\n", 0);
                if (strArray.Length == 2)
                  GameCanvas.panel.speacialTabName[index82] = strArray;
                if (strArray.Length == 1)
                {
                  GameCanvas.panel.speacialTabName[index82][0] = strArray[0];
                  GameCanvas.panel.speacialTabName[index82][1] = string.Empty;
                }
                int length32 = (int) msg.reader().readByte();
                Char.myCharz().infoSpeacialSkill[index82] = new string[length32];
                Char.myCharz().imgSpeacialSkill[index82] = new short[length32];
                for (int index83 = 0; index83 < length32; ++index83)
                {
                  Char.myCharz().imgSpeacialSkill[index82][index83] = msg.reader().readShort();
                  Char.myCharz().infoSpeacialSkill[index82][index83] = msg.reader().readUTF();
                }
              }
        ...
        default:
          ...
          {
            case -112:
              sbyte num134 = msg.reader().readByte();
              if (num134 == (sbyte) 0)
              ...
              if (num134 == (sbyte) 1)
              {
                ...
                goto label_919;
            case -107:
              sbyte num135 = msg.reader().readByte();
              if (num135 == (sbyte) 0)
              ...
              if (num135 == (sbyte) 2)
              {
                ...
                int length33 = (int) msg.reader().readUnsignedByte();
                Res.outz("num body = " + (object) length33);
                Char.myPetz().arrItemBody = new Item[length33];
                for (int index84 = 0; index84 < length33; ++index84)
                {
                  ...
                  {
                    Res.outz("1");
                    Char.myPetz().arrItemBody[index84] = new Item();
                    Char.myPetz().arrItemBody[index84].template = ItemTemplates.get(id12);
                    int type2 = (int) Char.myPetz().arrItemBody[index84].template.type;
                    Char.myPetz().arrItemBody[index84].quantity = msg.reader().readInt();
                    Res.outz("3");
                    Char.myPetz().arrItemBody[index84].info = msg.reader().readUTF();
                    Char.myPetz().arrItemBody[index84].content = msg.reader().readUTF();
                    int length34 = (int) msg.reader().readUnsignedByte();
                    Res.outz("option size= " + (object) length34);
                    if (length34 != 0)
                    {
                      Char.myPetz().arrItemBody[index84].itemOption = new ItemOption[length34];
                      for (int index85 = 0; index85 < Char.myPetz().arrItemBody[index84].itemOption.Length; ++index85)
                      {
                        int optionTemplateId = (int) msg.reader().readUnsignedByte();
                        int num136 = (int) msg.reader().readUnsignedShort();
                        if (optionTemplateId != -1)
                          Char.myPetz().arrItemBody[index84].itemOption[index85] = new ItemOption(optionTemplateId, num136);
                      }
                    }
                    switch (type2)
                    {
                      case 0:
                        Char.myPetz().body = (int) Char.myPetz().arrItemBody[index84].template.part;
                        continue;
                      case 1:
                        Char.myPetz().leg = (int) Char.myPetz().arrItemBody[index84].template.part;
                        continue;
                      default:
                        continue;
                    }
                ...
                for (int index86 = 0; index86 < Char.myPetz().arrPetSkill.Length; ++index86)
                {
                  short skillId = msg.reader().readShort();
                  if (skillId != (short) -1)
                  {
                    Char.myPetz().arrPetSkill[index86] = Skills.get(skillId);
                  }
                  else
                  {
                    Char.myPetz().arrPetSkill[index86] = new Skill();
                    Char.myPetz().arrPetSkill[index86].template = (SkillTemplate) null;
                    Char.myPetz().arrPetSkill[index86].moreInfo = msg.reader().readUTF();
                  }
                }
                if (GameCanvas.w > 2 * Panel.WIDTH_PANEL)
                {
    ...
    {
      Res.outz("Controller = " + ex.StackTrace);
    }
    finally
    {
      msg?.cleanup();
  ...
  public void messageNotMap(Message msg)
  {
    ...
    {
      sbyte num1 = msg.reader().readByte();
      Res.outz("---messageNotMap : " + (object) num1);
      switch (num1)
      {
        case 4:
  ...
  public void messageNotLogin(Message msg)
  {
    ...
    {
      sbyte num = msg.reader().readByte();
      Res.outz("---messageNotLogin : " + (object) num);
      if (num != (sbyte) 2)
        return;
      string str = msg.reader().readUTF();
      if (mSystem.isTest)
      ...
      try
      {
        ...
        Rms.saveRMSInt("AdminLink", (int) msg.reader().readByte());
      }
      catch (Exception ex)
      {
      }
  ...
  public void messageSubCommand(Message msg)
  {
    try
    {
      ...
      sbyte num1 = msg.reader().readByte();
      Res.outz("---messageSubCommand : " + (object) num1);
      switch (num1)
      {
        case 0:
        ...
        case 7:
          ...
          try
          {
            ...
            if (charInMap1.bag >= 201)
            {
              charInMap1.addEffChar(new Effect(charInMap1.bag, charInMap1, 2, -1, 10, (sbyte) 1)
              {
                typeEff = 5
              });
              break;
            }
            charInMap1.removeEffChar(0, 201);
            break;
          }
          catch (Exception ex)
          {
        ...
        case 13:
          ...
          int charId1 = msg.reader().readInt();
          Char @char = charId1 != Char.myCharz().charID ? GameScr.findCharInMap(charId1) : Char.myCharz();
          if (@char == null)
            break;
        ...
        case 14:
          ...
          if (num7 == (sbyte) 1)
          {
            ServerEffect.addServerEffect(11, charInMap7, 5);
            ServerEffect.addServerEffect(104, charInMap7, 4);
          }
          if (num7 == (sbyte) 2)
            charInMap7.doInjure();
          try
        ...
        case 15:
          ...
          charInMap8.cx = (int) msg.reader().readShort();
          charInMap8.cy = (int) msg.reader().readShort();
          charInMap8.statusMe = 1;
          charInMap8.cp3 = 3;
          ServerEffect.addServerEffect(109, charInMap8, 2);
          break;
        case 19:
        ...
        case 35:
          ...
          int charId2 = msg.reader().readInt();
          Res.outz("CID = " + (object) charId2);
          if (TileMap.mapID == 130)
            GameScr.gI().starVS();
          if (charId2 == Char.myCharz().charID)
          {
            Char.myCharz().cTypePk = msg.reader().readByte();
          ...
          {
            Char charInMap9 = GameScr.findCharInMap(charId2);
            if (charInMap9 != null)
            {
              Res.outz("type pk= " + (object) charInMap9.cTypePk);
              charInMap9.cTypePk = msg.reader().readByte();
              if (charInMap9.isAttacPlayerStatus())
                Char.myCharz().charFocus = charInMap9;
            }
          }
          for (int charId3 = 0; charId3 < GameScr.vCharInMap.size(); ++charId3)
          {
            Char charInMap10 = GameScr.findCharInMap(charId3);
            if (charInMap10 != null && charInMap10.cTypePk != (sbyte) 0 && (int) charInMap10.cTypePk == (int) Char.myCharz().cTypePk)
            {
    ...
    try
    {
      switch (msg.reader().readByte())
      {
        ...
        case 2:
          ...
          GameScr.addEffectEnd((int) type, (int) subtype, 0, GameCanvas.hw, GameCanvas.hh, 0, 0, (short) -1, (Point[]) null);
          break;
        case 4:
    ...
    try
    {
      ...
      switch (num1)
      {
        case -1:
          ...
          for (int index = 0; index < Char.myCharz().vSkill.size(); ++index)
          {
            if ((int) ((Skill) Char.myCharz().vSkill.elementAt(index)).template.id == (int) skill1.template.id)
            {
              Char.myCharz().vSkill.setElementAt((object) skill1, index);
              break;
            }
          }
          for (int index = 0; index < Char.myCharz().vSkillFight.size(); ++index)
          {
            if ((int) ((Skill) Char.myCharz().vSkillFight.elementAt(index)).template.id == (int) skill1.template.id)
            {
              Char.myCharz().vSkillFight.setElementAt((object) skill1, index);
              break;
            }
          }
          for (int index = 0; index < GameScr.onScreenSkill.Length; ++index)
          {
            if (GameScr.onScreenSkill[index] != null && (int) GameScr.onScreenSkill[index].template.id == (int) skill1.template.id)
            {
              GameScr.onScreenSkill[index] = skill1;
              break;
            }
          }
          for (int index = 0; index < GameScr.keySkill.Length; ++index)
          {
            if (GameScr.keySkill[index] != null && (int) GameScr.keySkill[index].template.id == (int) skill1.template.id)
            {
              GameScr.keySkill[index] = skill1;
              break;
            }
          }
          if ((int) Char.myCharz().myskill.template.id == (int) skill1.template.id)
            Char.myCharz().myskill = skill1;
          GameScr.info1.addInfo(mResources.hasJustUpgrade1 + skill1.template.name + mResources.hasJustUpgrade2 + (object) skill1.point, 0);
          break;
        case 0:
          short num2 = msg.reader().readShort();
          for (int index = 0; index < Char.myCharz().vSkill.size(); ++index)
          {
            Skill skill2 = (Skill) Char.myCharz().vSkill.elementAt(index);
            if ((int) skill2.skillId == (int) skillId)
            {
              skill2.curExp = num2;
              break;
            }
        ...
        case 1:
          ...
          for (int index1 = 0; index1 < Char.myCharz().vSkill.size(); ++index1)
          {
            Skill skill3 = (Skill) Char.myCharz().vSkill.elementAt(index1);
            if ((int) skill3.skillId == (int) skillId)
            {
              for (int index2 = 0; index2 < 20; ++index2)
                ImgByName.getImagePath("Skills_" + (object) skill3.template.id + "_" + (object) num3 + "_" + (object) index2, ImgByName.hashImagePath);
              break;
            }
          }
          break;
